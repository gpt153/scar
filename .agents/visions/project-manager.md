# Project Manager (PM) - Vision Document

**Note:** This workspace is called "Project Manager" or "PM" for short to avoid confusion with SCAR's orchestrator component.
...
```
.agents/visions/project-manager.md (this file)
  ↓ (user approves)
docs/PRD.md (generated by SCAR)
  ↓ (technical planning)
.agents/plans/project-manager.plan.md (implementation plan)
  ↓ (execution)
